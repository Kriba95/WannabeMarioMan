var kaboom = (() => {
    ...
    var et = (t, e, o) => e in t ? Qe(t, e, {
        ...
        le = (t, e) => {
            ...
            if (Je)
                for (var o of Je(e)) tn.call(e, o) && et(t, o, e[o]);
            return t
        },
        we = (t, e) => Qt(t, Jt(e));
    var r = (t, e) => Qe(t, "name", {
    ...
    function ee(t) {
        return {
            ...
            mult(e) {
                let o = [];
                for (let i = 0; i < 4; i++)
                    for (let m = 0; m < 4; m++) o[i * 4 + m] = this.m[0 * 4 + m] * e.m[i * 4 + 0] + this.m[1 * 4 + m] * e.m[i * 4 + 1] + this.m[2 * 4 + m] * e.m[i * 4 + 2] + this.m[3 * 4 + m] * e.m[i * 4 + 3];
                return ee(o)
            },
            multVec4(e) {
                return {
    ...
    function yt(t, e) {
        ...
        function A(h = We, x = Ke) {
            let b, L = on.replace("{{user}}", h != null ? h : We),
            ...
            return {
                ...
                send(P) {
                    ...
                    for (let X in P) {
                        ...
                        typeof F == "number" ? t.uniform1f(Z, F) : it(F) ? t.uniformMatrix4fv(Z, !1, new Float32Array(F.m)) : ye(F) ? t.uniform4f(Z, F.r, F.g, F.b, F.a) : ot(F) ? t.uniform3f(Z, F.x, F.y, F.z) : Re(F) && t.uniform2f(Z, F.x, F.y)
                    }
                    this.unbind()
                }
            }
...
` && (ge[ge.length - 1].push(ie), F += P), re = Math.max(re, F);
    ...
    var He, Ie, Ne, bt, on, an, We, Ke, xt = fe(() => {
        xe();
        pt();
        He = "topleft", Ie = 9, Ne = 65536, bt = 64, on = `
...
`;
    ...
    function Dt(t, e, o = {}) {
        ...
        return r(j, "defFont"), R(Se, Ct, 8, 8), {
            loadRoot: A,
            loadSprite: $,
            loadSound: I,
            loadFont: R,
        ...
        function v() {
            ...
            return new Promise((I, j) => {
                k.onopen = () => {
                    ...
                    if (e[w.type])
                        for (let S of e[w.type]) S(w.data, w.id)
                }
            })
        }
        r(v, "connect");
            ...
            function pe(s) {
                let n = {
                    ...
                    is(u) {
                        ...
                        if (Array.isArray(u)) {
                            for (let p of u)
                                if (!this._tags.includes(p)) return !1;
                            return !0
                        }
                    ...
                    trigger(u, ...p) {
                        ...
                        let l = y().events[u];
                        if (l)
                            for (let g of l) this.is(g.tag) && g.cb(this, ...p)
                    },
                    rmTag(u) {
...
`), l)
            ...
            function Oe(s, n, a) {
                ...
                return Ze(u.sub(d.scale(.5)), u.add(d.scale(.5)))
            }
